...
const std::array<MsColumnInfo, 29>& main_column_table() {
    static const std::array<MsColumnInfo, 29> table = {{
        ...
        {"ANTENNA1",
         ...
         0,
         {},
         "ID of first antenna in baseline",
         true},
        {"ANTENNA2",
         DataType::tp_int,
         ColumnKind::scalar,
         0,
         {},
         "ID of second antenna in baseline",
         true},
        ...
        {"FLAG",
         ...
         2,
         {},
         "Flags per channel per correlation",
         true},
        ...
        {"SIGMA",
         ...
         1,
         {},
         "Estimated noise per correlation",
         true},
        ...
        {"WEIGHT_SPECTRUM",
         ...
         2,
         {},
         "Weight per channel per correlation",
         false},
        {"SIGMA_SPECTRUM",
         DataType::tp_float,
         ColumnKind::array,
         2,
         {},
         "Sigma per channel per correlation",
         false},

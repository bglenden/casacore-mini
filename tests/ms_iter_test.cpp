...
static MeasurementSet create_multi_group_ms(const fs::path& path) {
    ...
    writer.add_antenna({.name = "A0", .station = {}, .type = "GROUND-BASED",
                         .mount = "ALT-AZ", .position = {}, .offset = {},
                         .dish_diameter = 0.0, .flag_row = false});
    writer.add_antenna({.name = "A1", .station = {}, .type = "GROUND-BASED",
                         .mount = "ALT-AZ", .position = {}, .offset = {},
                         .dish_diameter = 0.0, .flag_row = false});
    writer.add_field({.name = "F0", .code = {}, .time = 0.0, .num_poly = 0,
                       .source_id = -1, .flag_row = false});
    writer.add_field({.name = "F1", .code = {}, .time = 0.0, .num_poly = 0,
                       .source_id = -1, .flag_row = false});
    ...
    writer.add_spectral_window({.num_chan = 1, .name = "S0", .ref_frequency = 0.0,

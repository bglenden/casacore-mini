...
bool test_doppler_radio_to_z_roundtrip() {
    ...
    [[maybe_unused]] const auto& dv = std::get<DopplerValue>(back.value);
...
bool test_doppler_radio_to_ratio() {
    ...
    [[maybe_unused]] const auto& dv = std::get<DopplerValue>(ratio.value);
...
bool test_doppler_radio_to_gamma_roundtrip() {
    ...
    // gamma should be > 1
    [[maybe_unused]] const auto& gv = std::get<DopplerValue>(gamma.value);
    assert(gv.ratio > 1.0);
...
bool test_doppler_z_to_beta_consistency() {
    ...
    [[maybe_unused]] const auto& bv = std::get<DopplerValue>(beta_m.value);
...
bool test_doppler_identity() {
    ...
    [[maybe_unused]] const auto& dv = std::get<DopplerValue>(same.value);
...
bool test_frequency_identity() {
    ...
    [[maybe_unused]] const auto& fv = std::get<FrequencyValue>(same.value);
...
bool test_radial_velocity_identity() {
    ...
    [[maybe_unused]] const auto& rv = std::get<RadialVelocityValue>(same.value);
...
bool test_baseline_j2000_to_galactic() {
    ...
    [[maybe_unused]] const auto& bv = std::get<BaselineValue>(back.value);
...
bool test_uvw_j2000_to_galactic() {
    ...
    [[maybe_unused]] const auto& uv = std::get<UvwValue>(back.value);
...
bool test_earth_magnetic_frame_rotation() {
    ...
    [[maybe_unused]] const auto& ev = std::get<EarthMagneticValue>(back.value);
